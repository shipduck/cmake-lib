...
FUNCTION( SET_PCH )
  ...
  MACRO( GET_CONFIGS_FROM_TARGET )
    GET_TARGET_PROPERTY(TARGET_INCLUDES ${_PCH_TARGET} INCLUDE_DIRECTORIES)
    GET_TARGET_PROPERTY(TARGET_DEFINITIONS ${_PCH_TARGET} COMPILE_DEFINITIONS)
    GET_DIRECTORY_PROPERTY(DIRECTORY_DEFINITIONS COMPILE_DEFINITIONS)

    FOREACH( INCLUDE_PATH IN LISTS TARGET_INCLUDES )
      LIST( APPEND TARGET_CONFIGS "-I${INCLUDE_PATH}" )
    ENDFOREACH( INCLUDE_PATH )

    IF( TARGET_DEFINITIONS )
      FOREACH( DEFINITION IN LISTS TARGET_DEFINITIONS )
        LIST( APPEND TARGET_CONFIGS "-D${DEFINITION}" )
      ENDFOREACH( DEFINITION )
    ENDIF( TARGET_DEFINITIONS )

    IF( DIRECTORY_DEFINITIONS )
      FOREACH( DEFINITION IN LISTS DIRECTORY_DEFINITIONS )
        LIST( APPEND TARGET_CONFIGS "-D${DEFINITION}" )
      ENDFOREACH( DEFINITION )
    ENDIF( DIRECTORY_DEFINITIONS )
    MESSAGE(${TARGET_CONFIGS})
  ENDMACRO( GET_CONFIGS_FROM_TARGET )
  ...
  ELSEIF( CMAKE_CXX_COMPILER_ID STREQUAL "Clang" )
    ...
    GET_CONFIGS_FROM_TARGET()

    ADD_CUSTOM_COMMAND(
      OUTPUT "${_PCH_HEADER}.pch"
      COMMAND ${COMPILER} ${COMPILER_OPTION} ${_PCH_HEADER} -o ${_PCH_HEADER}.pch ${TARGET_CONFIGS}
      DEPENDS ${_PCH_HEADER}
  ...
  ELSEIF( GCC_VERSION )
    ...
    ADD_CUSTOM_COMMAND(
      ...
      COMMAND ${COMPILER} ${COMPILER_OPTION} ${_PCH_HEADER} ${TARGET_CONFIGS}
      DEPENDS ${_PCH_HEADER}
      IMPLICIT_DEPENDS ${LANG} ${_PCH_HEADER} )
    ADD_CUSTOM_TARGET(
      "${_PCH_TARGET}_pch"
